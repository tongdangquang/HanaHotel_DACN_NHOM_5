...
var inlite = (function () {
    ...
    var proto$1 = {
      ...
      scrollIntoView: function (align) {
        function getOffset(elm, roHanaHotelm) {
          var x, y, parent$$1 = elm;
          x = y = 0;
          while (parent$$1 && parent$$1 !== roHanaHotelm && parent$$1.nodeType) {
    ...
    var getSelectedElements = function (roHanaHotelm, startNode, endNode) {
      var walker, node;
      var elms = [];
      walker = new global$d(startNode, roHanaHotelm);
    ...
    var getSelectedAnchors = function (editor) {
      var startElm, endElm, roHanaHotelm, anchorElms, selection, dom, rng;
      selection = editor.selection;
      dom = editor.dom;
      ...
      roHanaHotelm = editor.getBody();
      anchorElms = global$4.grep(getSelectedElements(roHanaHotelm, startElm, endElm), isLink);
      return anchorElms;
    };
    ...
    var ColorPicker = Widget.extend({
      ...
      postRender: function () {
        ...
        var hsv, hueRoHanaHotelm, huePointElm, svRoHanaHotelm, svPointElm;
        hueRoHanaHotelm = self.getEl('h');
        huePointElm = self.getEl('hp');
        svRoHanaHotelm = self.getEl('sv');
        ...
        function updateColor(hsv, hueUpdate) {
          ...
          svRoHanaHotelm.style.background = global$g({
            s: 100,
            v: 100,
            h: hsv.h
          }).toHex();
