...
namespace Otel.WebUI.Controllers
{
    public class AdminGuestController : Controller
    {
        ...
        public async Task<IActionResult> Index()
        {
            ...
            var responseMessage = await client.GetAsync("https://localhost:44355/api/Guest");
        ...
        public async Task<IActionResult> AddGuest(CreateGuestDTO model)
        {
            ...
            var response = await client.PostAsync("https://localhost:44355/api/Guest", jsonContent);
        ...
        {
            var client = _httpClientFactory.CreateClient();
            var response = await client.GetAsync($"https://localhost:44355/api/Guest/{id}");
        ...
        public async Task<IActionResult> UpdateGuest(UpdateGuestDTO updateGuestViewModel)
        {
            ...
            var response = await client.PutAsync("https://localhost:44355/api/Guest", stringContent);
        ...
        {
            var client = _httpClientFactory.CreateClient();
            var response = await client.DeleteAsync($"https://localhost:44355/api/Guest/{id}");
            if (response.IsSuccessStatusCode)
                return RedirectToAction("Index");
